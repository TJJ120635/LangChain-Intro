...
下载 FP16 的模型参数，放进 chatglm-6b 文件夹
...
下载 INT4 的模型参数，放进 chatglm-6b-int4 文件夹
...
原因是 /usr/lib/x86_64-linux-gnu/ 中使用的是 525 版本，而不是 515 版本

导致驱动和 cuda library 不一致
...
此时需要更新 /usr/lib/x86_64-linux-gnu/ 中的驱动
